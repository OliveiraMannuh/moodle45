...
$string['selectweekdays'] = 'Select weekdays';
$string['timesettings'] = 'Time Settings';
$string['starthour'] = 'Start Time';
$string['endhour'] = 'End Time';
$string['schedulepreview'] = 'Schedule Preview';
$string['previewschedules'] = 'Preview Schedules';
$string['generateschedules'] = 'Generate Schedules';
$string['manageschedules'] = 'Manage Schedules';
...
$string['selectdaterange_placeholder'] = 'Click to select date range';
