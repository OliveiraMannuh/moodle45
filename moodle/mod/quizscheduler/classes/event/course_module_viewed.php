...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'quizscheduler';
    }
    ...
    public static function get_name() {
        return get_string('eventcoursemoduleviewed', 'mod_quizscheduler');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the quiz scheduler activity with " .
